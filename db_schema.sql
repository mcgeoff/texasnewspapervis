...
create table newspaper_count (id text, pub text, city text, state text, dateTime date, mNumber int, mCommon int, mProper int, mSymbol int, mUnknown int, mBad int, mTotal int);
